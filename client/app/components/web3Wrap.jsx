            ...
            <div className='columns'>
              ...
              <div className='column is-two-thirds'>
                ...
                <h2 className='subtitle'>
                  However, you need to unlock your account or create a new one.
                  Click the Fox in the top-right corner of your browser, then
                  refresh the page.
                </h2>
              </div>
              <div className='column' />
          ...
          <Hero>
            <div className='columns'>
              ...
              <div className='column is-two-thirds'>
                ...
                <h2 className='subtitle'>
                  To use Etherplate you will need to install the{' '}
                  <a
                  ...
                  extension for Chrome, Firefox or Brave desktop browsers:
                </h2>
                <a href='https://metamask.io' title='Download Metamask'>
                  <img
                    src={`/${DownloadMetamaskButtonImg}`}
                    alt='Metamask Download Button'
                    width='200'
                  />
                </a>
                <br />
